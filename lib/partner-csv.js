...
function findPartnerType(types, value) {
  ...
  if (/(shelter|animal control|animal care|humane society|\bspca\b|adoption|animal rescue)/.test(typeValue)) return types.find(candidate => candidate.slug.toLowerCase() === 'shelter');
  return undefined;
}
