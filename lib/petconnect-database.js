...
async function ensurePetConnectSchema(connection) {
  for (const migration of ['003_petconnect.sql', '004_petconnect_alerts.sql', '005_petconnect_locations.sql', '006_petconnect_admin.sql', '007_petconnect_geocoding.sql']) {
