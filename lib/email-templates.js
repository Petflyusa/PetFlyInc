...
function partnerInvitation({ organizationName, claimUrl, siteUrl }) { return { subject: 'Join the PetConnect network', ...layout({ siteUrl, title: 'You are invited to PetConnect', greeting: `Hello ${organizationName},`, body: 'Pet Fly Inc invites your organization to join the PetConnect network.', cta: { label: 'Set your PetConnect password', url: claimUrl } }) }; }
